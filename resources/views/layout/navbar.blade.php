      ...
      <div>
        <ul class="navbar-nav">
          <li class="nav-item mx-md">
            <a class="nav-links btn btn-link text-decoration-none" href="{{ url('register') }}">Daftar</a>
          </li>
      ...
      @endif
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="{{ asset('frontend/images/Benefits.jpg') }}" class="rounded-circle" width="30">
